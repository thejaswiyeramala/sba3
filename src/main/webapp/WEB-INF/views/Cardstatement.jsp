...
<table border="1" cellpadding="5">
        <caption><h3>Card Transactions</h3></caption>
        <tr>
            <th>UCI</th>
            <th>ID</th>
            <th>Card Type</th>
            <th>Card Number</th>
            <th>Date</th>
            <th>CardRequest ID</th>
        </tr>
       
        <c:forEach var="cards" items="${cards}">
            <tr>
                <td style="text-align:center"><c:out value="${cards.uci}"/></td>
                <td style="text-align:center"><c:out value="${cards.ID}" /></td>
                <td style="text-align:center"><c:out value="${cards.CardType}" /></td>
                <td style="text-align:center"><c:out value="${cards.cardNumber}" /></td>
                <td style="text-align:center"><c:out value="${cards.date}" /></td>
                <td style="text-align:center"><c:out value="${cards.CardRequestID}" /></td>
            </tr>
        </c:forEach>
	</table>
	<br>
