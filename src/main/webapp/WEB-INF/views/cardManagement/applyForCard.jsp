...
<h2>Cards Management</h2>
		<hr />
	<div>
	<spring:form action="${pageContext.request.contextPath}/cardManagemt/saveCard" id="ApplyforCardform" method="post" modelAttribute="applyCardInputDto">
	<br></br>
		<div>
	...
	<div>
		<div><spring:label path="cardType">Select Card Type</spring:label>
			<spring:select path="cardType" class="select">
				...
				<spring:option value="1" label="Master"/>
			</spring:select>
			</div>
	</div>
		<br></br>
