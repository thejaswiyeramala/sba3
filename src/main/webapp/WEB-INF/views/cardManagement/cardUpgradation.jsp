...
<div id="CardUpgradation" class="tabcontent">
	<div>
	<spring:form action="${pageContext.request.contextPath}/cardManagemt/cardUpgradeSave"  method="post" modelAttribute="cardUpgradationInputDto">
	<div>
		<div><spring:label path="cardCategory">Select Card Category</spring:label>
			<spring:select path="cardCategory" class="select">
				<spring:option value="0" label="Debit"/>
				<spring:option value="1" label="Credit"/>
			</spring:select>
			</div>
	</div>
	<br></br>
	...
	<br><br/>
	<div>
	<spring:label path="cardType">Default Card Type</spring:label>
		<spring:input path="cardType" type="text" value="visa" readonly="true"/>
	</div>
	<br><br/>
	<div>
		<div><spring:label path="cardType">Select Card Type to upgrade</spring:label>
			<spring:select path="cardType" class="select">
				<spring:option value="0" label="Amex"/>
				<spring:option value="1" label="Visa"/>
				<spring:option value="2" label="Paypal"/>
			</spring:select>
			</div>
	</div>
  <div>
