...
<h2>Cards Management</h2>
		<hr />
  <a href="${pageContext.request.contextPath}/cardManagemt/applyCard">ApplyforCard</a>
  <br></br>
  <a href="#" id="ResetPINlink" onclick="showForm('ResetPINform','ResetPINlink')">ResetPIN</a>
  <br></br>
  <a href="${pageContext.request.contextPath}/cardManagemt/cardUpgrade">CardUpgradation</a>
  <br></br>
  <a href="#"  id="CardStatementlink">CardStatement</a>
  <br></br>
