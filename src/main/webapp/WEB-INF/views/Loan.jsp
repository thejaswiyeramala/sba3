...
<div align=left>
<!-- Tab content -->
<div id="ApplyforLoan" class="tabcontent">
<h2>Loans Management</h2>
		<hr />
  <a href="${pageContext.request.contextPath}/LoanManagement/applyLoan">Apply For Loan</a>
  <br></br>
  <a href="${pageContext.request.contextPath}/LoanManagement/payEMI">Pay EMI</a>
  </div>
  </div>
  </div>
